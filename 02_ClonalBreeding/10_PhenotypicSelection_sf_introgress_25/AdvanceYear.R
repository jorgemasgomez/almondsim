...
ECT1= selectind_selfcompatible(original_pop = ACT3, haploposition = prms$SIPos,
...
ACT1=selectind_selfcompatible(original_pop = HPT4, haploposition = prms$SIPos,
...
F1= randCrossGamSI_selfcomp_compulsory(prms = prms,pop = Parents, nCrosses = nCrosses, nProgeny = nProgeny,
                                       percentage_selfcompatible = 0.25)
